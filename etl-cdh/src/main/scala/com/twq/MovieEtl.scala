...
--executor-cores 1 \
/home/hadoop-twq/hive-course/etl-cdh-1.0-SNAPSHOT.jar \
  hdfs://hadoop2:8020/user/hadoop-twq/hive-course/douban/movie-video.csv \
  hdfs://hadoop2:8020/user/hadoop-twq/hive-course/douban/parquet
  */
object MovieEtl {
